...
<header class="header">
	<div class="slika">
		...
		<ul>
			...
			<li>
				<a class="nav-bar" href="welcome.php?logout='1'">Log out</a>
			</li>
		</ul>
		</nav>
		<div class="zavesa">
	...
	<?php
		...
		if(!isset($_SESSION['username'])){
			...
			$upit="SELECT * from korisnik where username='$korisnickoIme'";
...
<section id="about" class="about-section">
	...
	<div class="about-div">
		...
		<hr>
		<p>Welcome to our Car Rent website <?php echo $_SESSION['username']; ?></p>
		<h3>Awarded Cars</h3>
...
<section id="menu" class="fix-slika-menu">
	...
	<div class="menu-menu">
		<div class="breakfast">
			...
			<hr class="hr-menu">
			<h2 class="h2-menu"><a href="index.php">Renault Clio</a></h2>
