...
<section id="register" class="register-section">
	...
	<div class="register-div">
		...
		<h2>REGISTER</h2>
			...
			<p>Korisnicko ime: <input type="text" required name="username" value="<?php echo $username; ?>"/></p>
			<p>Lozinka: <input type="password" required name="password" value="<?php echo $password; ?>"/></p>
...
<section id="contact" class="reservation">
	<div class="number-res">
		<h2 class="h2-res">ZELITE DA NAPRAVITE REZERVACIJU? POZOVITE <strong>+381645472355</strong></h2>
	</div>
</section>
