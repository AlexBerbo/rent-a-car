...
<section id="about" class="about-section">
	...
	<div class="about-div">
		...
		<form method='post' action='nalog.php'>
          	...
          	?>
            	<tr>
             		...
             		<td><?php echo $row['datum']; ?></td>
              		...
              		<td><button><a href="delete.php?id=<?php echo $row['idrezervacija']; ?>">DELETE</a></button></td>
              		<td><button><a href="editRez.php?id=<?php echo $row['idrezervacija']; ?>">EDIT DATE</a></button></td>
            	</tr> 
           	<?php
          	}
      	...
      	<p>Number of reservations - <?php echo $count; ?></p>
      	<p>Your account ID is - <?php echo $korisnikid; ?></p>
